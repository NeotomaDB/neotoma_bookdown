...
* **AgeTypeID (Foreign Key)**: Age type or units. Field links to the `AgeTypes`{.interpreted-text
    role="ref"} table.
...
This table stores relative chronologic data. Relative Ages are assigned to Analysis Units, The Relative Age data along with any possible `Geochronology`{.interpreted-text role="ref"} and `Tephrachronology`{.interpreted-text role="ref"} data are used to create a chronology.
